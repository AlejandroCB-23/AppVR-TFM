...
public class ModoTest : MonoBehaviour
{
    ...
    List<ShipSpawnEvent> BuildSchedule()
    {
        ...
        int[,] rawScheduleData = new int[,]
        {
            ...
            {1824, 1, 0, 0}, {1849, 2, 1, 2}, {1872, 0, 1, 1}, {1896, 1, 1, 0},
            {1920, 2, 0, 2}, {1944, 0, 0, 1}, {1968, 1, 1, 0}, {1993, 2, 1, 2},
            {2016, 0, 1, 1}, {2040, 1, 0, 0}, {2064, 2, 1, 2}, {2088, 0, 1, 1},
            {2112, 1, 1, 0}, {2137, 2, 0, 2}, {2160, 0, 0, 1}, {2184, 1, 1, 0},
            {2208, 2, 1, 2}, {2233, 0, 1, 1}, {2256, 1, 0, 0}, {2280, 2, 1, 2},
            {2304, 0, 1, 1}, {2328, 1, 1, 0}, {2352, 2, 0, 2}, {2377, 0, 0, 1},
            {2400, 1, 1, 0}, {2424, 2, 1, 2}, {2448, 0, 1, 1}, {2473, 1, 0, 0},
            {2496, 2, 1, 2}, {2520, 0, 1, 1}, {2544, 1, 1, 0}, {2568, 2, 0, 2},
            {2592, 0, 0, 1}, {2617, 1, 1, 0}, {2640, 2, 1, 2}, {2664, 0, 1, 1},
            {2688, 1, 0, 0}, {2712, 2, 1, 2}, {2736, 0, 1, 1}, {2760, 1, 1, 0},
            {2784, 2, 0, 2}, {2808, 0, 0, 1}, {2832, 1, 1, 0}, {2856, 2, 1, 2},
            {2880, 0, 1, 1}, {2904, 1, 0, 0}, {2928, 2, 1, 2}, {2952, 0, 1, 1},
            {2976, 1, 1, 0}, {3000, 2, 0, 2}
        };
